...
import com.ahmetkilic.eaframework.ea_networking.EAListResponseListener;
...
import com.ahmetkilic.eaframework.ea_utilities.tools.ViewTools;
...
class EASpinnerDialog<T> extends Dialog implements
    ...
    private void getOnlineData(final boolean isLoadMore) {
        ...
        EARequestBuilder builder = operationsListener.getRequestBuilder()
                ...
                .setParamsEncoding(paramsEncoding)
        ...
        if (v.getId() == R.id.btn_close) {
            ...
            if (multipleSelectionEnabled) {
                ...
                if (singleSelectionListener != null) {
                    if (firstIsDefault && initialItems.size() > 0) {
                        singleSelectionListener.onItemSelected(initialItems.get(0));
                    } else
