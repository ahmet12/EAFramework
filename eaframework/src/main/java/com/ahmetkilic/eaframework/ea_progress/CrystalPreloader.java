package com.ahmetkilic.eaframework.ea_progress;
...
import com.ahmetkilic.eaframework.ea_progress.base.BasePreloader;
import com.ahmetkilic.eaframework.ea_progress.preloaders.circular.Alternative;
import com.ahmetkilic.eaframework.ea_progress.preloaders.circular.BallBeat;
import com.ahmetkilic.eaframework.ea_progress.preloaders.circular.BallPulse;
import com.ahmetkilic.eaframework.ea_progress.preloaders.circular.BallPulseSync;
import com.ahmetkilic.eaframework.ea_progress.preloaders.circular.BallRing;
import com.ahmetkilic.eaframework.ea_progress.preloaders.circular.BallScale;
import com.ahmetkilic.eaframework.ea_progress.preloaders.circular.BallSpinFade;
import com.ahmetkilic.eaframework.ea_progress.preloaders.circular.Chronos;
import com.ahmetkilic.eaframework.ea_progress.preloaders.circular.Circular;
import com.ahmetkilic.eaframework.ea_progress.preloaders.circular.ExpandableBalls;
import com.ahmetkilic.eaframework.ea_progress.preloaders.circular.HalfMoon;
import com.ahmetkilic.eaframework.ea_progress.preloaders.circular.Hasher;
import com.ahmetkilic.eaframework.ea_progress.preloaders.circular.InCircle;
import com.ahmetkilic.eaframework.ea_progress.preloaders.circular.Pulse;
import com.ahmetkilic.eaframework.ea_progress.preloaders.circular.SkypeBalls;
import com.ahmetkilic.eaframework.ea_progress.preloaders.circular.TimeMachine;
import com.ahmetkilic.eaframework.ea_progress.preloaders.circular.TornadoCircle1;
import com.ahmetkilic.eaframework.ea_progress.preloaders.circular.TornadoCircle2;
import com.ahmetkilic.eaframework.ea_progress.preloaders.circular.TornadoCircle3;
import com.ahmetkilic.eaframework.ea_progress.preloaders.circular.Triplex;
import com.ahmetkilic.eaframework.ea_progress.preloaders.circular.Ventilator;
import com.ahmetkilic.eaframework.ea_progress.preloaders.rectangular.LineScale;
import com.ahmetkilic.eaframework.ea_progress.preloaders.rectangular.LineScalePulseOut;
import com.ahmetkilic.eaframework.ea_progress.preloaders.rectangular.LineScalePulseOutRapid;
...
public class CrystalPreloader extends View {
    ...
    protected synchronized void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        loader.onDraw(canvas, fgPaint, bgPaint, loader.getWidth(), loader.getHeight(), loader.getWidth() / (float) 2.0, loader.getHeight() / (float) 2.0);
    }
}
