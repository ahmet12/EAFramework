package com.ahmetkilic.eaframework.ea_slider.indicator;
...
import com.ahmetkilic.eaframework.ea_slider.EASlider;
...
public class EAIndicator extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private void initSlider() {
        if (mSlider != null && mSlider.getAdapter() != null) {
    ...
    public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
        if (slider_width != 0 && item_width != 0 && mSlider != null && mSlider.getAdapter() != null) {
            int real_pos = position % mSlider.getAdapter().getRealCount();
            float rate = (float) slider_width / (float) item_width;
    ...
    private void addIconNormal() {
        ...
        AppCompatImageView imageView = view.findViewById(R.id.ic_single);
    ...
    private void addIconCurrent() {
        ...
        AppCompatImageView imageView = currentIconView.findViewById(R.id.ic_single);
        RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) imageView.getLayoutParams();
        ...
        AppCompatImageView imageView2 = tempView.findViewById(R.id.ic_single);
